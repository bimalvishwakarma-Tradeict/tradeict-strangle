...
# Long far-OTM basket wings (iron condor) — NOT structure-level hedge
ROLE_BASKET_WING_CALL = "BASKET_WING_CALL"
ROLE_BASKET_WING_PUT = "BASKET_WING_PUT"

# All short-basket roles (shorts + wings). Never include HEDGE_*.
BASKET_LEG_ROLES = (
    ROLE_BASKET_CALL,
    ROLE_BASKET_PUT,
...
HEDGE_LEG_ROLES = (ROLE_HEDGE_CALL, ROLE_HEDGE_PUT)
